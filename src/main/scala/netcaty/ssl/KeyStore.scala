...
/** https://raw.githubusercontent.com/netty/netty/netty-4.0.19.Final/example/src/main/java/io/netty/example/securechat/SecureChatKeyStore.java */
object KeyStore {
  private val DATA: Array[Byte] = Array[Short](
  ...
  val CERTIFICATE_PASSWORD = "secret".toCharArray
  val KEY_STORE_PASSWORD   = "secret".toCharArray

  def asInputStream = new ByteArrayInputStream(DATA)
}
